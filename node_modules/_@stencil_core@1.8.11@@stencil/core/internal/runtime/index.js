...
const addHostEventListeners = (elm, hostRef, listeners, attachParentListeners) => {
    if (appData.BUILD.hostListener && listeners) {
        ...
        listeners.map(([flags, name, method]) => {
            ...
            (hostRef.$rmListeners$ = (hostRef.$rmListeners$ || [])).push(() => platform.plt.rel(target, name, handler, opts));
        });
    }
};
...
const connectedCallback = (elm) => {
    if ((platform.plt.$flags$ & 1 /* isTmpDisconnected */) === 0) {
        ...
        if (appData.BUILD.hostListenerTargetParent) {
            ...
            platform.addHostEventListeners(elm, hostRef, cmpMeta.$listeners$, true);
        }

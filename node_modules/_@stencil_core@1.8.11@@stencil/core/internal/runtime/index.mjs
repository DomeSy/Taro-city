/*
 Stencil Runtime v0.0.0-dev.20200226032620 | MIT Licensed | https://stenciljs.com
 */
import { BUILD, NAMESPACE } from '@stencil/core/internal/app-data';
import { plt, doc, win, supportsListenerOptions, getHostRef, styles, supportsConstructibleStylesheets, supportsShadowDom, consoleDevError, consoleDevWarn, isMemberInElement, consoleError, nextTick, writeTask, loadModule, addHostEventListeners as addHostEventListeners$1, registerHost, forceUpdate as forceUpdate$1, Context, readTask } from '@stencil/core/internal/platform';
let scopeId;
let contentRef;
let hostTagName;
let i = 0;
...
const connectedCallback = (elm) => {
    if ((plt.$flags$ & 1 /* isTmpDisconnected */) === 0) {
        ...
        if (BUILD.hostListenerTargetParent) {
            ...
            addHostEventListeners$1(elm, hostRef, cmpMeta.$listeners$, true);
        }
...
export { Host, addHostEventListeners, attachShadow, bootstrapLazy, connectedCallback, createEvent, defineCustomElement, disconnectedCallback, forceModeUpdate, forceUpdate, getAssetPath, getConnect, getContext, getElement, getMode, getRenderingRef, getValue, h, insertVdomAnnotations, parsePropertyValue, postUpdateComponent, proxyComponent, proxyCustomElement, renderVdom, setMode, setValue };

...
var AtSwipeAction = /** @class */ (function (_super) {
    ...
    AtSwipeAction.prototype.render = function () {
        ...
        return (React.createElement(View, { id: "swipeAction-" + componentId, className: rootClass, onTouchMove: this.handleTouchMove, onTouchEnd: this.handleTouchEnd, onTouchStart: this.handleTouchStart },
            ...
            Array.isArray(options) && options.length > 0 ? (React.createElement(AtSwipeActionOptions, { options: options, componentId: componentId, onQueryedDom: this.handleDomInfo }, options.map(function (item, key) { return (React.createElement(View, { key: item.text + "-" + key, style: item.style, onClick: function (e) { return _this.handleClick(item, key, e); }, className: classnames('at-swipe-action__option', item.className) },

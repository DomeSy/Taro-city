    ...
    var AtSwipeAction = /** @class */ (function (_super) {
        ...
        AtSwipeAction.prototype.render = function () {
            ...
            return (React__default.createElement(components.View, { id: "swipeAction-" + componentId, className: rootClass, onTouchMove: this.handleTouchMove, onTouchEnd: this.handleTouchEnd, onTouchStart: this.handleTouchStart },
                ...
                Array.isArray(options) && options.length > 0 ? (React__default.createElement(AtSwipeActionOptions, { options: options, componentId: componentId, onQueryedDom: this.handleDomInfo }, options.map(function (item, key) { return (React__default.createElement(components.View, { key: item.text + "-" + key, style: item.style, onClick: function (e) { return _this.handleClick(item, key, e); }, className: classnames('at-swipe-action__option', item.className) },
